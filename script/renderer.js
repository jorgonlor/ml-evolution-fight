...
class Renderer {
    ...
    defineDrawingFunctions() {
        ...
        Creature.prototype.draw = function (ctx, scale, point2canvas) {
            ...
            // weapon
            if(this.alive) {
                let p_near = vadd(this.body.p, vmult(this.body.rot, this.radius));
                let p_far = vadd(this.body.p, vmult(this.body.rot, this.weaponLength()));
                self.drawLine(p_near, p_far, 'red', 1);
            }
        }
